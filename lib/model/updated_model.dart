class Autogenerated {
  ...
  Autogenerated({int status, Ticket ticket}) {
    this._status = status;
    this._ticket = ticket;
  }
  ...
  Contract.fromJson(Map<String, dynamic> json) {
    ...
    if (json['paymentSchedules'] != null) {
      ...
      json['paymentSchedules'].forEach((v) {
        _paymentSchedules.add(new Null.fromJson(v));
      });
    }
    _id = json['id'];
    _uuid = json['uuid'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._paymentSchedules != null) {
      data['paymentSchedules'] =
          this._paymentSchedules.map((v) => v.toJson()).toList();
    }
    data['id'] = this._id;
    data['uuid'] = this._uuid;
    data['createdby'] = this._createdby;
